...
function renderSiswa() {
  ...
  // Cache the table rows to avoid re-querying the DOM on every input/change
...
function initNav() {
  document.querySelectorAll(".nav__link").forEach((link) => {
    link.addEventListener("click", (e) => {
      ...
      // Re-render sections when navigated to ensure fresh data/filters
...
function getNextSchoolDay(fromDate) {
  ...
  do {
    ...
    nextDay.getDay() === 0 || // Minggu
    nextDay.getDay() === 6 || // Sabtu
    isHoliday(nextDay)
  );
