...
async function init() {
  ...
  fetch(
    ...
    .then((res) => res.text())
    .then((count) => {
      document.getElementById("site-access").innerText =
        `Total kunjungan situs: ${count}`;
    })
    .catch(() => {
      document.getElementById("site-access").innerText =
        `Total kunjungan situs: 0`;
    });
}
...
function updateSchoolStatus() {
  ...
  const startTime = 6.5;
  const endTime = day === 5 ? 11.417 : 14.0;
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  s.src =
    "https://pl28647327.effectivegatecpm.com/8c/67/78/8c677812fd8ef224a9c01327372ff15a.js";
